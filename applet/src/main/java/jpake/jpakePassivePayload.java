...
public final class jpakePassivePayload {
    ...
    public byte[] toBytes(){
        ...
        //Util.arrayCopyNonAtomic(publicA3Encoded, (short) 0, output, currStart,publicA3Encoded.length);
        ...
        //Util.arrayCopyNonAtomic(publicV3Encoded, (short) 0, output, currStart,publicV3Encoded.length);
        ...
        //Util.arrayCopyNonAtomic(result3, (short) 0, output, currStart,result3.length);
        return output;
    }
